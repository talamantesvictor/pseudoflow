...
export type ArithmeticToken =          { name: 'ArithmeticToken', rule?: RegExp, value?: string };
...
export type UnknownToken =             { name: 'UnknownToken', rule?: RegExp, value?: string };
...
export type IfNode =                   { name: 'IfNode', argument: ExpressionNode, body: SentencesNode };
...
export type ForNode =                  { name: 'ForNode', argument: ExpressionNode, to: number, steps: number, body: SentencesNode };
export type WhileNode =                { name: 'WhileNode', argument: ExpressionNode, body: SentencesNode};
export type DowhileNode =              { name: 'DowhileNode', argument: ExpressionNode, body: SentencesNode};
